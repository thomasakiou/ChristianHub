...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xFFF5F5F4);
  late Color secondaryBackground = const Color(0xFFEDE6D6);
  ...
  late Color botton = const Color(0xFF57A44D);
  late Color botton1 = const Color(0xFF78BC71);
}
