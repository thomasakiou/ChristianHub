...
class NewUpdatePageWidget extends StatefulWidget {
  const NewUpdatePageWidget({
    super.key,
    required this.addnewTextRef,
    this.newparentRef,
  });

  final DocumentReference? addnewTextRef;
  final DocumentReference? newparentRef;
...
class _NewUpdatePageWidgetState extends State<NewUpdatePageWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<NewChaptersRecord>(
      stream: NewChaptersRecord.getDocument(widget.addnewTextRef!),
      builder: (context, snapshot) {
        ...
        final newUpdatePageNewChaptersRecord = snapshot.data!;
                ...
                children: [
                  Padding(
                    ...
                    child: StreamBuilder<NewTestamentRecord>(
                      stream:
                          NewTestamentRecord.getDocument(widget.newparentRef!),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                          return Center(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${columnNewTestamentRecord.books} - ${newUpdatePageNewChaptersRecord.chapter.toString()}',
                                ...
                                child: Column(
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        TextFormField(
                                          controller: _model.textController ??=
                                            ...
                                            text: newUpdatePageNewChaptersRecord
                                                .text,
                                          ),
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          await newUpdatePageNewChaptersRecord
                                              .reference
                                              .update(
                                                  createNewChaptersRecordData(
