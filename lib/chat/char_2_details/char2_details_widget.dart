...
import 'char2_details_model.dart';
export 'char2_details_model.dart';

class Char2DetailsWidget extends StatefulWidget {
  const Char2DetailsWidget({
    super.key,
  ...
  @override
  State<Char2DetailsWidget> createState() => _Char2DetailsWidgetState();
}

class _Char2DetailsWidgetState extends State<Char2DetailsWidget> {
  late Char2DetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Char2DetailsModel());
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            actions: [
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(0.0, 50.0, 16.0, 8.0),
                child: FlutterFlowIconButton(
