...
import 'schema/old_testament_record.dart';
import 'schema/new_testament_record.dart';
import 'schema/chapters_record.dart';
import 'schema/new_chapters_record.dart';
import 'schema/messages_record.dart';
import 'schema/audio_record.dart';
import 'schema/video_record.dart';
import 'schema/devotional_record.dart';
...
export 'schema/old_testament_record.dart';
export 'schema/new_testament_record.dart';
export 'schema/chapters_record.dart';
export 'schema/new_chapters_record.dart';
export 'schema/messages_record.dart';
export 'schema/audio_record.dart';
export 'schema/video_record.dart';
export 'schema/devotional_record.dart';
...
/// Functions to query OldTestamentRecords (as a Stream and as a Future).
Future<int> queryOldTestamentRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      OldTestamentRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<OldTestamentRecord>> queryOldTestamentRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      OldTestamentRecord.collection,
      OldTestamentRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<OldTestamentRecord>> queryOldTestamentRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<OldTestamentRecord>> queryOldTestamentRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, OldTestamentRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      OldTestamentRecord.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<OldTestamentRecord> data) {
          for (var item in data) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query NewTestamentRecords (as a Stream and as a Future).
Future<int> queryNewTestamentRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      NewTestamentRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<NewTestamentRecord>> queryNewTestamentRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      NewTestamentRecord.collection,
      NewTestamentRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<NewTestamentRecord>> queryNewTestamentRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<NewTestamentRecord>> queryNewTestamentRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, NewTestamentRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      NewTestamentRecord.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<NewTestamentRecord> data) {
          for (var item in data) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query NewChaptersRecords (as a Stream and as a Future).
Future<int> queryNewChaptersRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      NewChaptersRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<NewChaptersRecord>> queryNewChaptersRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      NewChaptersRecord.collection(parent),
      NewChaptersRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<NewChaptersRecord>> queryNewChaptersRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<NewChaptersRecord>> queryNewChaptersRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, NewChaptersRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      NewChaptersRecord.collection(parent),
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<NewChaptersRecord> data) {
          for (var item in data) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query DevotionalRecords (as a Stream and as a Future).
Future<int> queryDevotionalRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DevotionalRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DevotionalRecord>> queryDevotionalRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DevotionalRecord.collection,
      DevotionalRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DevotionalRecord>> queryDevotionalRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<DevotionalRecord>> queryDevotionalRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, DevotionalRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      DevotionalRecord.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<DevotionalRecord> data) {
          for (var item in data) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
