...
class _AiPageWidgetState extends State<AiPageWidget> {
  ...
  void initState() {
    ...
    _model.aitextTextController ??= TextEditingController();
    _model.aitextFocusNode ??= FocusNode();
                          ...
                          Expanded(
                            child: Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 8.0, 0.0),
                              child: TextFormField(
                                controller: _model.aitextTextController,
                                focusNode: _model.aitextFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText:
                                      'Type what you what to know here...',
                                ...
                                validator: _model.aitextTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              await geminiGenerateText(
                                context,
                                _model.aitextTextController.text,
                              ).then((generatedText) {
                                safeSetState(
                              ...
                              setState(() {
                                _model.aitextTextController?.clear();
                              });
